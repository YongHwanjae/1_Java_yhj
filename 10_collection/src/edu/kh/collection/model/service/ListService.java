...
public class ListService {
	...
	/* List : 자료들을 순차적으로 나열한 자료구조(배열이랑 비슷)
	 *  -> Interfacce
	 * 
	 *  - 인덱스를 이용해 순서를 유지
	...
	public void ex1() {
		...
		// - 특징
		// 1) 크기 제약이 없다
		// 2) 추가, 삭제, 정렬 등의 기능이 구현되어 있다.
		// 3) 여러 타입의 객체를 저장할 수 있다.
		//    ==> Object 참조 변수의 묶음
		
		
		// java.util 패키지  - 모든 컬렉션이 존재
//		ArrayList list = new ArrayList(); // 기본 생성자 - > 10칸
		...
		list.add(new String()); //String도 객체라서 new 연산자
