...
public class StudentView {
	...
	public void displayMenu() {
		...
		do {
	         ...
	         System.out.println();
	        	...
	        	input = -1; // 첫 반복시 잘못 입력된 경우 while문이 종료되지 않도록 하는 값
	...
	public void removeStudent() {
		...
		}else {System.out.println(s.getName() + " 학생의 정보가 삭제되었습니다.");
	}
