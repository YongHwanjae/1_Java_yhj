...
import edu.kh.poly.ex2.model.vo.YHJCalculator;
...
//		Animal a = new Animal(); //Cannot instantiatie the type Animal
//		 -> 안됨
...
//		p1.breath();
		...
		// 다들 강제 오버라이딩한 breath()란 공통적인 메서드를 
	...
	public void ex3() {
		...
		Calculator cal = new YHJCalculator();
