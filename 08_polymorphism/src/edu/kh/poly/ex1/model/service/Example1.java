...
//    				System.out.println("자동차 정보 : " + c);}
		...
		public void ex3() {
			...
			// 다운 캐스팅 
			// - 업캐스팅이 적용된 상황에서 (부모 참조변수 = 자식 객체)
			//   부모 참조 변수를 자식타입으로 바꿔(강제 형변환, 얕은 복사)
			...
			((Spark)c1).dc();
			// 형변환 먼저 진행 후 dc() 호출 = 연산자 우선순위 때문에
			// -> 다운 캐스팅
			...
			System.out.println(c1 instanceof Spark); // ture
